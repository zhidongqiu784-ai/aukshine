async function run() {
  ...
  const DEFAULT_VISIBLE_KEYWORD_COUNT = 3;
  ...
  const INITIAL_COLUMNS = [
    ...
    { key:'daily_promo_day',              src:'daily',  field:'promo_day',                   label:'是否促销',        hidden:false, pinned:false, width:80,  editable:false },
    { key:'daily_promotion_days',         src:'daily',  field:'promotion_days',              label:'推广天数',        hidden:false, pinned:false, width:80,  editable:false },
    { key:'daily_promo_days_40d',         src:'daily',  field:'promo_days_40d',              label:'前40天促销天数',  hidden:false, pinned:false, width:110, editable:false },
    { key:'daily_promo_days_90d',         src:'daily',  field:'promo_days_90d',              label:'前90天促销天数',  hidden:false, pinned:false, width:110, editable:false },
    ...
    { key:'weekly_cvr',                   src:'weekly', field:'guanggaocvr',                 label:'CVR',             hidden:false, pinned:false, width:90,  editable:false },
    ...
    { key:'weekly_ad_click_count',        src:'weekly', field:'guanggaodianji',              label:'广告点击量',      hidden:false, pinned:false, width:90,  editable:false },
    ...
    { key:'weekly_page_views_total',       src:'weekly', field:'page_views_total',           label:'页面浏览量',      hidden:false, pinned:false, width:90,  editable:false },
    ...
    { key:'weekly_shared_ads_sbv_cost',    src:'weekly', field:'shared_ads_sbv_cost',        label:'SBV 广告费',      hidden:false, pinned:false, width:90,  editable:false },
    ...
    // profit
    { key:'profit_profit_margin_front',        src:'profit', field:'profit_margin',              label:'利润率（忽略coupon使用率）',           hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_gross_revenue_local',        src:'profit', field:'gross_revenue_local',        label:'成交额-算费率',           hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_net_revenue_local',          src:'profit', field:'net_revenue_local',          label:'净销售额（当地币）-算利润率',         hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_net_profit_local',           src:'profit', field:'net_profit_local',           label:'纯利润（当地币）',           hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_profit_margin',              src:'profit', field:'profit_margin',              label:'利润率（忽略coupon使用率）',           hidden:false, pinned:false, width:100,  editable:false },
    { key:'profit_cumulative_break_even',      src:'profit', field:'cumulative_break_even',      label:'累计盈亏平衡（当地币）',         hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_unit_profit_local',          src:'profit', field:'unit_profit_local',          label:'单个利润（不算测评和广告，算了退货）当地币',         hidden:false, pinned:false, width:90,  editable:false },
    { key:'profit_unit_profit_after_ad_local', src:'profit', field:'unit_profit_after_ad_local', label:'单台利润（当地币）',   hidden:false, pinned:false, width:110, editable:false },
    { key:'profit_unit_profit_rmb',            src:'profit', field:'unit_profit_rmb',            label:'单台利润（RMB）',    hidden:false, pinned:false, width:110, editable:false },
    { key:'profit_product_cost_total',         src:'profit', field:'product_cost_total',         label:'产品成本费',       hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_product_cost_ratio',         src:'profit', field:'product_cost_ratio',         label:'产品成本占比',     hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_ad_cost_ratio',              src:'profit', field:'ad_cost_ratio',              label:'广告费率',         hidden:false, pinned:false, width:80,  editable:false },
    { key:'profit_review_cost_ratio',          src:'profit', field:'review_cost_ratio',         label:'测评费率',         hidden:false, pinned:false, width:80,  editable:false },
    { key:'profit_review_refund_total',        src:'profit', field:'review_refund_total',        label:'总测评回款金额',     hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_review_refund_cost',         src:'profit', field:'review_refund_cost',         label:'测评总返款费',     hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_review_profit_total',        src:'profit', field:'review_profit_total',        label:'总测评利润金额',   hidden:false, pinned:false, width:110, editable:false },
    { key:'profit_review_refund_per_unit',     src:'profit', field:'review_refund_per_unit',     label:'单个测评返款金额（当地币）-（负数）',     hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_review_unit_profit',         src:'profit', field:'review_unit_profit',         label:'单个测评订单的售价回款利润金额',   hidden:false, pinned:false, width:110, editable:false },
    { key:'profit_offsite_commission_cost',    src:'profit', field:'offsite_commission_cost',    label:'站外佣金费',       hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_offsite_cost_per_order',     src:'profit', field:'offsite_cost_per_order',     label:'站外单均成本',     hidden:false, pinned:false, width:100, editable:false },
    { key:'product_config_coupon_order_ratio_estimated', src:'product_config', field:'coupon_order_ratio_estimated', label:'产生coupon费用的订单比例-预估', hidden:false, pinned:false, width:130, editable:true },
    { key:'profit_coupon_total_cost',          src:'profit', field:'coupon_total_cost',          label:'Coupon 总费用',     hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_flash_sale_price',           src:'profit', field:'flash_sale_price',           label:'秒杀价格（当地币）',         hidden:false, pinned:false, width:90,  editable:false },
    { key:'profit_flash_sale_qty',             src:'profit', field:'flash_sale_qty',             label:'秒杀总单量',       hidden:false, pinned:false, width:80,  editable:false },
    { key:'profit_flash_sale_days',            src:'profit', field:'flash_sale_days',            label:'秒杀天数',         hidden:false, pinned:false, width:80,  editable:false },
    { key:'profit_flash_sale_total_cost',      src:'profit', field:'flash_sale_total_cost',      label:'秒杀总费用（当地币）',       hidden:false, pinned:false, width:100, editable:false },
    { key:'profit_flash_sale_cost_per_order',  src:'profit', field:'flash_sale_cost_per_order',  label:'秒杀平均每单的费用 (当地币)',     hidden:false, pinned:false, width:100, editable:false },
  ];

  const MONEY_FIELDS = new Set(['daily_price','list_price','price_after_discount','review_discounted_price','gross_revenue_local','net_revenue_local','net_profit_local','cumulative_break_even','unit_profit_local','unit_profit_after_ad_local','unit_profit_rmb','product_cost_total','review_refund_total','review_refund_cost','review_profit_total','review_refund_per_unit','review_unit_profit','offsite_commission_cost','offsite_cost_per_order','coupon_total_cost','flash_sale_price','flash_sale_total_cost','flash_sale_cost_per_order','ads_sp_cost','ads_sp_sales','ads_sd_cost','ads_sd_sales','shared_ads_sb_cost','shared_ads_sb_sales','shared_ads_sbv_cost','shared_ads_sbv_sales','guanggaohuafei','ad_direct_sales_amount','ad_sales_amount']);
  const RATE_FIELDS = new Set(['off','real_session_conversion_rate','order_link_real_session_conversion_rate','zongcvr','guanggaocvr','volume_cvr','acos','tacos','natural_traffic_proportion','return_rate','return_goods_rate','profit_margin','product_cost_ratio','ad_cost_ratio','review_cost_ratio','coupon_order_ratio_estimated','ctr','adv_rate','natural_single_ratio']);
  ...
  const SRC_GROUP_CONFIG = [
    ...
    { src:'keyword_position', label:'🔎 SQP 关键词', color:COLOR_YELLOW },
    { src:'competitor', label:'🏁 竞对 ASIN', color:COLOR_BLUE },
    { src:'order_link', label:'🔗 订单链接追踪', color:COLOR_ROSE },
    { src:'profit', label:'💵 利润表',   color:COLOR_TEAL },
    { src:'product_config', label:'⚙️ 产品配置', color:COLOR_GRAY },
  ];
  ...
  const saveColsToUser = async (cols) => {
    ...
    try {
      ...
      const preserved = existingSaved.filter((c) => c?.key && !incomingKeys.has(c.key) && (isDynamicColumnKey(c.key) || staticKeys.has(c.key)));
  ...
  const RichTextImageCell = ({ value, onSave, placeholder = '+' }) => {
    ...
    return React.createElement(React.Fragment, null,
      React.createElement('div', { onDoubleClick: () => { setTempContent(content || ''); setIsEditing(true); }, style: { height: '46px', display: 'flex', alignItems: 'center', justifyContent: isEmpty ? 'center' : undefined, gap: '6px', padding: '3px 5px', background: content ? '#fafafa' : '#fff', border: '1px solid #e5e7eb', borderRadius: '6px', cursor: 'cell', overflow: 'hidden', boxSizing: 'border-box' } },
        imageUrls.length > 0 && React.createElement('div', { style: { display: 'flex', alignItems: 'center', gap: '4px', flexShrink: 0 } },
          visibleImages.map((url, i) => React.createElement('img', { key: i, src: url, onClick: (e) => { e.stopPropagation(); setPreviewUrl(url); }, style: { width: '36px', height: '30px', objectFit: 'cover', borderRadius: '4px', border: '1px solid #d9d9d9', background: '#fff', cursor: 'zoom-in' } })),
          extraCount > 0 && React.createElement('div', { style: { width: '28px', height: '30px', borderRadius: '4px', background: '#f0f0f0', color: '#666', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 700, border: '1px solid #ddd' } }, `+${extraCount}`)
        ),
        React.createElement('div', { style: { flex: isEmpty ? '0 0 auto' : 1, minWidth: 0, height: isEmpty ? '100%' : undefined, display: 'flex', flexDirection: 'column', justifyContent: isEmpty ? 'center' : undefined, alignItems: isEmpty ? 'center' : undefined, gap: '2px' } },
          React.createElement(Tooltip, { title: cleanText || (imageUrls.length ? `${imageUrls.length} 张截图` : placeholder), placement: 'topLeft', mouseEnterDelay: 0.3 },
  ...
  const MergedTable = () => {
      ...
      return [...(records || [])]
        ...
        .map((kw, idx) => {
          ...
          return {
            ...
            label,
            hidden: idx >= DEFAULT_VISIBLE_KEYWORD_COUNT,
            pinned: false,
    ...
    const buildDynamicCompetitorCols = useCallback((records) => {
      ...
      [...(records || [])]
        ...
        .forEach((comp, compIdx) => {
          ...
          const groupLabel = `${role}:${asinLabel}`;
    ...
    const recalcAllCoreFormulas = useCallback(async (sourceRows = [], optionsArg = false) => {
      ...
      try {
        ...
        keys.forEach((key) => {
          ...
          const sameOff = String(source.off ?? '') === String(updates.off ?? '');
          const samePromoDay = String(source.promo_day ?? '') === String(updates.promo_day ?? '');
          const sameLpDuration = String(source.lp_duration_days ?? '') === String(updates.lp_duration_days ?? '');
          const samePromoDays40d = String(source.promo_days_40d ?? '') === String(updates.promo_days_40d ?? '');
          const samePromoDays90d = String(source.promo_days_90d ?? '') === String(updates.promo_days_90d ?? '');
          const sameTargetGap = String(source.target_gap ?? '') === String(updates.target_gap ?? '');
          ...
          const currentProfitRow = { ...(existingProfitMap[key] || {}), ...(sourceRowsByKey[key] || {}) };
          ...
          const sameNetProfitLocal = String(currentProfitRow.net_profit_local ?? '') === String(netProfitLocal ?? '');
          ...
          const sameGrossRevenueLocal = String(currentProfitRow.gross_revenue_local ?? '') === String(grossRevenueLocal ?? '');
          ...
          const sameTacos = String(currentProfitRow.tacos ?? '') === String(tacos ?? '');
          if (!sameTacos) {
            patchMap[key] = { ...(patchMap[key] || {}), tacos };
            queueProfitUpdate(key, baseProfitUpdate, { tacos });
          }
          const sameNetRevenueLocal = String(currentProfitRow.net_revenue_local ?? '') === String(netRevenueLocal ?? '');
          ...
          const sameCouponTotalCost = String(currentProfitRow.coupon_total_cost ?? '') === String(couponTotalCost ?? '');
          ...
          const sameFlashSaleTotalCost = String(currentProfitRow.flash_sale_total_cost ?? '') === String(flashSaleTotalCost ?? '');
          ...
          const sameFlashSaleCostPerOrder = String(currentProfitRow.flash_sale_cost_per_order ?? '') === String(flashSaleCostPerOrder ?? '');
          ...
          const sameProfitMargin = String(currentProfitRow.profit_margin ?? '') === String(profitMargin ?? '');
          if (!sameProfitMargin) {
          ...
          const sameUnitProfitAfterAdLocal = String(currentProfitRow.unit_profit_after_ad_local ?? '') === String(unitProfitAfterAdLocal ?? '');
          ...
          const sameUnitProfitRmb = String(currentProfitRow.unit_profit_rmb ?? '') === String(unitProfitRmb ?? '');
          ...
          const adCostRatio = adSpend == null || grossRevenueLocal == null || grossRevenueLocal === 0
            ? null
            : roundRate(adSpend / grossRevenueLocal, 4);
          const sameAdCostRatio = String(currentProfitRow.ad_cost_ratio ?? '') === String(adCostRatio ?? '');
          if (!sameAdCostRatio) {
            patchMap[key] = { ...(patchMap[key] || {}), ad_cost_ratio: adCostRatio };
            queueProfitUpdate(key, baseProfitUpdate, { ad_cost_ratio: adCostRatio });
          }
          const sameUnitProfitLocal = String(currentProfitRow.unit_profit_local ?? '') === String(roundedMatchedGrossProfit ?? '');
          ...
          const sameProductCostTotal = String(currentProfitRow.product_cost_total ?? '') === String(productCostTotal ?? '');
          ...
          const sameProductCostRatio = String(currentProfitRow.product_cost_ratio ?? '') === String(productCostRatio ?? '');
          ...
          const sameReviewRefundPerUnit = String(currentProfitRow.review_refund_per_unit ?? '') === String(reviewRefundPerUnit ?? '');
          ...
          const sameReviewRefundCost = String(currentProfitRow.review_refund_cost ?? '') === String(reviewRefundCost ?? '');
          ...
          const sameReviewCostRatio = String(currentProfitRow.review_cost_ratio ?? '') === String(reviewCostRatio ?? '');
          ...
          const sameReviewUnitProfit = String(currentProfitRow.review_unit_profit ?? '') === String(roundedReviewUnitProfit ?? '');
          ...
          const sameReviewRefundTotal = String(currentProfitRow.review_refund_total ?? '') === String(reviewRefundTotal ?? '');
        ...
        Object.entries(dailyRowsByAsinCountry).forEach(([asinCountry, groupRows]) => {
          ...
          [...groupRows]
            ...
            .forEach((row) => {
              ...
              const sameCumulativeBreakEven = String(currentProfitRow.cumulative_break_even ?? '') === String(cumulativeBreakEven ?? '');
        ...
        if (!updateJobs.length && !profitUpdateJobs.length) {
        ...
        reportProgress(`准备写回 ${updateJobs.length + profitUpdateJobs.length} 条...`, 55);
        let successCount = 0;
        let failCount = 0;
        for (let i = 0; i < updateJobs.length; i += 8) {
          const batch = updateJobs.slice(i, i + 8);
          const results = await Promise.allSettled(
        ...
        for (let i = 0; i < profitUpdateJobs.length; i += 8) {
          const batch = profitUpdateJobs.slice(i, i + 8);
          const results = await Promise.allSettled(
            batch.map(async (job) => {
              try {
                await ctx.request({
          ...
          const percent = profitUpdateJobs.length ? 75 + (done / profitUpdateJobs.length) * 20 : 95;
        ...
        return { total: updateJobs.length + profitUpdateJobs.length, success: successCount, skipped: keys.length - Math.max(updateJobs.length, profitUpdateJobs.length) };
      } catch (err) {
    ...
    const loadData = useCallback(async (options = {}) => {
      ...
      try {
        ...
        const countryAsinKeys = [...new Set(dailyRecords.map((d) => toCountryAsinKey(d.country, d.asin)).filter(Boolean))];
        ...
        const [weeklyRecords, targetRecords, profitRecords, orderLinkRecords, productConfigRecords, sqpKeywordRecords, sqpKeywordPositionRecords, competitorRecords, competitorDailyRecords] = await Promise.all([
        ...
        const mergedData = dailyRecords.map((d) => {
          ...
          const merged = { ...weeklyData, ...targetData, ...profitData, ...orderLinkData, ...productConfigData, ...d };
          merged.__src = {
            weekly: weeklyData,
            target: targetData,
            profit: profitData,
        ...
        if (!skipFormula) {
          try {
            await recalcAllCoreFormulas(mergedData, true);
          } catch (formulaErr) {
            ctx.message.warning(`公式计算失败：${formulaErr?.message || ''}`);
          }
        }
        return mergedData;
      } catch (err) {
    ...
    }, [filterAsin, filterCountry, currentUserName, currentUserLevel, getDateRange, getDailySort, fetchAllList, buildDynamicKeywordCols, buildDynamicCompetitorCols, recalcAllCoreFormulas]);
    ...
    const autoRefreshCurrentPage = useCallback(async () => {
      ...
      try {
        ...
        const mergedData = await loadData({ page: curPageRef.current, size: pageSizeRef.current, skipFormula: true });
        const hasCurrentAsinCountry = !!(filterCountry && filterAsin);
        let formulaRows = mergedData;
        if (hasCurrentAsinCountry) {
    ...
    }, [calcLoading, currentUserLevel, currentUserName, editingCell, fetchAllList, filterAsin, filterCountry, finishFormulaProgress, loadData, loading, recalcAllCoreFormulas, refreshingData, resetFormulaProgress, saving, showFormulaProgress]);
    ...
    const addKeyword = useCallback(async () => {
      ...
      try {
        ...
        await ctx.request({ url: `${meta.collection}:create`, method: 'post', data: withCreateTimestamps({ country_asin: currentCountryAsin, country: filterCountry, asin: filterAsin, [meta.nameField]: keyword }) });
        setKeywordDraft('');
    ...
    }, [currentCountryAsin, filterAsin, filterCountry, getSqpManagerMeta, keywordDraft, keywordTab, refreshAfterManagerChange]);
    ...
    const addCompetitor = useCallback(async () => {
      ...
      try {
        setManagerSaving(true);
        await ctx.request({ url: 'order_link_competitor_asins:create', method: 'post', data: withCreateTimestamps({ country_asin: currentCountryAsin, country: filterCountry, asin: filterAsin, role, competitor_asin: competitorAsin }) });
        setCompetitorDraft('');
    ...
    }, [competitorDraft, currentCountryAsin, filterAsin, filterCountry, managerItems, refreshAfterManagerChange]);
    ...
    const allColumns = useMemo(() => {
      ...
      const insertKeywordAfter = columns.findIndex((c) => c.key === 'daily_star_rating');
      const withKeywords = insertKeywordAfter >= 0
        ? [...columns.slice(0, insertKeywordAfter + 1), ...keywordCols, ...columns.slice(insertKeywordAfter + 1)]
        : [...columns, ...keywordCols];
      const insertCompetitorAfter = withKeywords.findIndex((c) => c.key === 'weekly_ranking');
    ...
    const selectAll      = () => { updateAndSave((p) => p.map((c) => ({ ...c, hidden: false }))); setDynamicHiddenBySrc('keyword_position', false); setDynamicHiddenBySrc('competitor', false); };
    const deselectAll    = () => { updateAndSave((p) => p.map((c) => ({ ...c, hidden: true  }))); setDynamicHiddenBySrc('keyword_position', true); setDynamicHiddenBySrc('competitor', true); };
    const selectGroup    = (src) => { if (src === 'keyword_position' || src === 'competitor') { setDynamicHiddenBySrc(src, false); return; } updateAndSave((p) => p.map((c) => c.src === src ? { ...c, hidden: false } : c)); };
    const deselectGroup  = (src) => { if (src === 'keyword_position' || src === 'competitor') { setDynamicHiddenBySrc(src, true); return; } updateAndSave((p) => p.map((c) => c.src === src ? { ...c, hidden: true  } : c)); };
        ...
        if (failCount === 0) {
          ...
          if (changedRows.length) {
            ...
            if (changedRows.length <= 3) {
              await recalcAllCoreFormulas(changedRows, { silent: true, onProgress: showFormulaProgress });
            } else {
          ...
          ctx.message.success(changedRows.length
            ? `粘贴成功，已更新 ${requests.length + richOps.length} 个单元格，公式已同步`
    ...
    }, [finishFormulaProgress, isCellEditable, loadData, normalizeSelection, pagedData, parsePastedValue, recalcAllCoreFormulas, resetFormulaProgress, saving, selectedRange, showFormulaProgress, syncCoreFormulasForRows, visibleCols]);
    ...
    }, [finishFormulaProgress, isCellEditable, loadData, normalizeSelection, pagedData, recalcAllCoreFormulas, resetFormulaProgress, saving, selectedRange, showFormulaProgress, syncCoreFormulasForRows, visibleCols]);
    ...
    const saveEdit = useCallback(async () => {
      ...
      try {
        ...
        setData((prev) => prev.map((r) => (r.country_asin_date || r.id) === rowId ? mergeSourcePatch(r, src, { [field]: valueToSave }) : r));
        setEditingCell(null);
        setEditValue(null);
        savedCell = true;
        setSaving(false);
        ...
        window.setTimeout(async () => {
          try {
            const formulaResult = await recalcAllCoreFormulas([nextRow], true);
            if (formulaResult?.success > 0) {
              ...
              if (formulaUpdates) {
                setData((prev) => prev.map((r) => (r.country_asin_date || r.id) === rowId ? mergeFormulaPatch(r, formulaUpdates) : r));
              }
            }
          } catch (formulaErr) {
    ...
    }, [editingCell, editValue, data, dynamicCompetitorCols, saving, cancelEdit, recalcAllCoreFormulas, fetchAllList]);
    ...
    const refreshData  = useCallback(async () => {
      ...
      try {
        ...
        showFormulaProgress({ label: '正在读取当前 ASIN / 国家全部日期...', percent: 12 });
        const rows = await loadFormulaRowsForCurrentCountryAsin();
        ...
        ctx.message[ok ? 'success' : 'warning'](ok ? '数据已刷新并重新计算公式' : '数据已刷新，部分公式计算失败');
        finishFormulaProgress(ok ? '刷新公式计算完成' : '刷新完成，部分公式失败');
      } catch (err) {
        resetFormulaProgress();
        throw err;
      } finally {
    ...
    }, [calcLoading, finishFormulaProgress, loadData, loadFormulaRowsForCurrentCountryAsin, loading, recalcAllCoreFormulas, refreshingData, resetFormulaProgress, showFormulaProgress]);
    ...
    const saveStaticRichCell = useCallback(async (row, col, newContent) => {
      ...
      try {
        ...
        setData((prev) => prev.map((r) => (r.country_asin_date || r.id) === rowId ? mergeSourcePatch(r, col.src, { [col.field]: valueToSave }) : r));
    ...
    }, [captureTableScroll, restoreTableScroll, syncCoreFormulasForRows]);
    ...
    const renderSortMark = (key) => React.createElement('span', {
      style: { marginLeft: '3px', opacity: sortConfig.key === key ? 1 : 0.4, fontSize: `${FONT_SIZE_XS}px`, flexShrink: 0 },
    ...
    const renderHeaderLabel = (col) => React.createElement(Tooltip, {
      ...
      style: { display: 'block', minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', cursor: 'help' },
    }, col.label));
    const renderCompetitorGroupHeaderLabel = (col) => React.createElement(Tooltip, {
      ...
      style: { display: 'block', minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', cursor: 'help', color: 'currentColor' },
    }, col._competitorGroupLabel || col.label));
        ...
        : React.createElement('div', null,
            ...
            managerLoading
              ...
              : React.createElement('div', { style: { display: 'flex', flexDirection: 'column', gap: 8 } },
                  ...
                  sortedManagerItems.map((item) => React.createElement('div', { key: item.id, style: { display: 'grid', gridTemplateColumns: '72px 1fr auto', gap: 8, alignItems: 'center' } },
                  ...
                  React.createElement('tr', null,
                    visibleCols.map((col) => {
                      ...
                      if (isCompetitorSubCol) {
                        ...
                        React.createElement('span', { style: { display: 'flex', alignItems: 'center', maxWidth: '100%', minWidth: 0, overflow: 'hidden', verticalAlign: 'middle' } },
                      ...
                      return React.createElement('th', {
                        ...
                        style: {
                          position: 'sticky', top: 0, left: isPinned ? `${leftOff}px` : undefined,
                          zIndex: isPinned ? 4 : 2,
