...
SELECT 30, 'PLAN_SOURCE', IF(
    ...
    AND shop IS NOT NULL AND TRIM(shop) <> '' AND shop <> '合计'
    AND original_date IS NOT NULL AND asin_match_count = 1,
    1, 0
), '目标必须是一个具体店铺的 shipment_plan_v2 计划'
