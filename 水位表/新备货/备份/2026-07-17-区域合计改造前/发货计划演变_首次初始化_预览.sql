...
a1_supply_status AS (
    SELECT
        ...
        CASE
            ...
            WHEN af.shop_id IS NULL THEN 'SHOP_ID_MISSING'
            WHEN af.shop_match_count <> 1 THEN 'SHOP_ID_AMBIGUOUS'
...
SELECT
    ...
    CASE cr.generation_status
        WHEN 'SHOP_ID_MISSING' THEN '店铺未匹配到 shop.sid'
        WHEN 'SHOP_ID_AMBIGUOUS' THEN '店铺在 shop 表中匹配到多条记录'
