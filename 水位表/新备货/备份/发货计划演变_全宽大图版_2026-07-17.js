...
function V19TrendChart({ row, changes, role, poApproved, orderWeek, channelOptions, onApply, onSandbox }) {
  ...
  const W = 1600; const H = 350; const L = 54; const R = 22; const T = 28; const B = 42;
  ...
  return h('div', {
    ...
    style: { position: 'relative', width: '100%', minWidth: 0, margin: '0 auto', padding: '12px 12px 16px', background: '#fbfcfe', boxSizing: 'border-box', whiteSpace: 'normal' },
  },
