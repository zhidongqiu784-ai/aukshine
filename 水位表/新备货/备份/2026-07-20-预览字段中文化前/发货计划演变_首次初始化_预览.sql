...
SELECT
    ...
    cr.latest_demand,
    cr.candidate_number AS raw_candidate_number,
    cr.sequential_candidate_number,
    cr.sequential_service_demand,
    cr.sequential_raw_inventory_at_service_start,
    cr.seq_previous_candidate,
    cr.sequential_inventory_at_service_start,
